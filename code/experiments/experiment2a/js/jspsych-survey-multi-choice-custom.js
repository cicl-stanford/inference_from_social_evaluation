...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '.jspsych-content-wrapper { min-height: 400px; width: 900px; display: flex; align-items: start; }';
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      for (var j = 0; j < question.options.length; j++) {
        ...
        html += '<div id="'+option_id_name+'" class="jspsych-survey-multi-choice-option" style="float: left; margin-left: 200px">';
